...
Begin
  ...
  Begin
    ...
    LagUpTime.Caption:='Secs';
    LagDownTime.Caption:='Secs';
    LagUpStrokes.Caption:='Strk';
    LagDownStrokes.Caption:='Strk';

    TotalCircStrks.Caption:='Strk';
    TotalStrokes.Caption:='Strk';
    StrokeCounter.Caption:='Strk';
